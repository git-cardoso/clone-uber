...
import com.ondemandbay.taxianytime.driver.base.BaseMapFragment;
import com.ondemandbay.taxianytime.driver.locationupdate.LocationHelper;
import com.ondemandbay.taxianytime.driver.locationupdate.LocationHelper.OnLocationReceived;
import com.ondemandbay.taxianytime.driver.model.BeanRoute;
import com.ondemandbay.taxianytime.driver.model.BeanStep;
...
import com.ondemandbay.taxianytime.driver.widget.MyFontTextViewMedium;
...
public class JobFragment extends BaseMapFragment implements
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (jobStatus == AndyConstants.IS_WALK_COMPLETED) {
			titleTime.setText(getResources()
					.getString(R.string.text_total_time));
			titleDistance.setText(getResources().getString(
	...
	public void onTaskCompleted(String response, int serviceCode) {
		...
		case AndyConstants.ServiceCode.WALK_STARTED:
			...
			if (parseContent.isSuccess(response)) {
				...
				titleTime.setText(getResources().getString(
