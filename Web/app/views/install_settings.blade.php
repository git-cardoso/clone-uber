...
<div class="box box-primary">
    ...
    <!-- form start -->
    <form role="form" method="POST" action="{{ URL::Route('AdminDeveloperDetailsSave') }}">

        <div class="box-body">
            <div class="form-group">
                <label>Company Name</label>

                <input type="text"  name="company_name" class="form-control" placeholder="Developer Company Name" value="{{ Config::get('app.developer_company_name') }}">

            </div>
            <div class="form-group">
                <label>Web site link</label>
                <input type="text" name="web_link" class="form-control" placeholder="Developer Web site link" value="{{ Config::get('app.developer_company_web_link') }}">

            </div>
            <div class="form-group">
                <label>Email</label>

                <input type="text" name="email" class="form-control" placeholder="Developer Email" value="{{ Config::get('app.developer_company_email') }}">

            </div>
            <div class="form-group">
                <label>FaceBook Link</label>

                <input type="text" name="fb_link" class="form-control" placeholder="Developer FaceBook Link" value="{{ Config::get('app.developer_company_fb_link') }}">

            </div>
            <div class="form-group">
                <label>Twitter Link</label>

                <input type="text" name="twit_link" class="form-control" placeholder="Developer Twitter Link" value="{{ Config::get('app.developer_company_twitter_link') }}">
