<html>
    ...
    <body style="margin: 0px; padding: 0px; border: 0px;font-family: sans-serif;">
        ...
        <div style="margin: 0px auto;width: 90%; padding: 15px;background-color: #ff9d3d;color: #FFFFFF;">
            <!-- logo -->            
            <div>
                <div style="float: left;"><img alt="logo" src="<?php echo asset_url(); ?><?php echo $logo; ?>" style="width: 200px;padding: 0px 0px 12px 0px;"><img alt="logo" src="{{ asset_url() }}/image/e_receipt.png" style="width: 150px;padding: 0px 0px 12px 50px;"></div>
