                ...
                foreach ($settings as $setting) {
                    if ($setting->page == 4) {
                        ...
                        <?php } else if ($setting->key == 'auto_transfer_provider_payment') { ?>
                            <div class="form-group">
                                <label><?php echo ucwords(str_replace("_", " ", $setting->key)); ?>&nbsp;<a href="#" data-toggle="tooltip" title="<?= $setting->tool_tip; ?>"><img src="<?php echo web_url(); ?>/image/icon-tooltip.jpg"></a></label>
