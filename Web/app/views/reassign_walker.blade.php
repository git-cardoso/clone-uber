            ...
            {center: new google.maps.LatLng(34.102475, - 118.35401),
                    ...
                    var marker = new google.maps.Marker();
                            downloadUrl("<?php echo web_url(); ?>/admin/walk/alternative_walkers_xml/<?php echo $walk_id; ?>",
                                                                ...
                                                                html = "client_name </b></p><p><span class='icon-phone' style=''></span><span style='margin-left:5px;'>" + contact + "</span></p><p>Current ".Config::get('app.generic_keywords.Provider')." <br> " + name + "</p>";
                                                                } else if (type == 'client') {
                                ...
                                alert("Sorry, This ".Config::get('app.generic_keywords.Provider')." is Busy now...");
                                }
                                });
                                }
                                ...
                                controlDiv.style.padding = '5px';
                                        ...
                                        '<img src="<?php echo asset_url(); ?>/image/client-70.png" style="height:25px;"/> Available '.Config::get('app.generic_keywords.Provider').'<br />' +
                                        '<img src="<?php echo asset_url(); ?>/image/client-red.png" style="height:25px;"/> Busy '.Config::get('app.generic_keywords.Provider').'<br />' +
                                        '<img src="<?php echo asset_url(); ?>/image/driver-70.png" style="height:25px;"/>Current '.Config::get('app.generic_keywords.Provider').'<br />' +
